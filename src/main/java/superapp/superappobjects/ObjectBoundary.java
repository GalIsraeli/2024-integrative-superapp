...
public class ObjectBoundary {
	...
	{
		this.objectId = ob.getObjectId();
		this.type = ob.getType();
		this.alias = ob.getAlias();
		this.location = ob.getLocation();
		this.active = ob.getActive();
		this.creationTimestamp = ob.getCreationTimestamp();
		this.createdBy = ob.getCreatedBy();
		this.objectDetails = ob.getObjectDetails();
	}*/
